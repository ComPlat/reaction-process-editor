...
export const notifications = {
	...
	automation_mode: {
		has_been_changed: {
			...
			message: "Changes in the automation mode will impact some Actions and their forms. The affected actions can not be adapted automatically. Please check and manually adapt / correct the Actions where required!",
			type: "warning",
